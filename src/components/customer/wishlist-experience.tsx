...
export function WishlistExperience() {
  ...
  const products = items.map((item) => item.product ?? demoProducts.find((product) => product.id === item.productId)).filter((product): product is typeof demoProducts[number] => Boolean(product));
